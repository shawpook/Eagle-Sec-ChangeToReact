module.exports = {
	getDataUrl: ({ filePath, type, size }) => {
		return new Promise((resolve, reject) => {
			...
			var $iframe = $(`<iframe src="../app/model-viewer/website/index.html#model=${fileUrl}" style="width: ${size}px; height: ${size}px; pointer-events: none; opacity: 0;" callback="${callbackFunctionName}"></iframe>`);
