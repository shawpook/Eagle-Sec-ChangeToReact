...
const PENDING_DATA_FIELDS = [
  ...
  'canUseTouchID', 'colorDistancesMap', 'containFolders', 'containTags',
  ...
  'globalKeywords', 'historySearchKeywords', 'hsks', 'imagesDir',
  'initDetailMode', 'isContainAlphabet', 'isEnglish', 'isExpandFolder',
  'isExpandQuickAccess', 'isExpandSmartFolder', 'isHideMainNav', 'isItemBindCalculated',
  'isKeywordCN', 'isKeywordTW', 'isLibrarySaving', 'isOpenWebpagePanel',
  ...
  'lastProcessCount', 'lastSelectedTag', 'lastestAddItem', 'len',
  'libraryHistory', 'libraryImagesPath', 'libraryLoadedProgress', 'libraryModificationTime',
  'libraryName', 'libraryPath', 'listLayoutSettings', 'listMetaType',
  'loadMoreDisable', 'metadataQueueLength', 'newGroupName', 'openWithInfo',
  'orderBy', 'orderByName', 'page', 'paletteQueueDelay',
  'paletteQueueLength', 'paletteQueuePaused', 'preelaborations', 'progress',
  'quickAccess', 'regenerateThumbnailQueue', 'rootDir', 'saveFolderDebounceTimeout',
  'searchIndex', 'searchRegexGroup', 'selectingTags', 'showAnnotation',
  'showFileExtension', 'showFileExtensionLabel', 'showMetas', 'showNTFSWarning',
  'showName', 'showOriginalImageWhenLarge', 'showSlowNotify', 'showSuggestions',
  'sidebarIndex', 'sidebarList', 'smartFolderList', 'sortIncrease',
