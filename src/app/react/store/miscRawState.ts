...
const MIGRATED: ReadonlyArray<keyof MiscRawState> = [
  ...
  'uploadUrl', 'filterWithTags', 'openGifContextMenu', 'getExifPath', 'clearAllTags', 'openHelpCenter', 'openGetStarted', 'whenLayoutChange', 'removeRecentFolder', 'updateItemListView', 'preventMiddleClick', 'changeFolderName', 'saveFolder', 'openLibrary', 'getRecentFoldersForAPI', 'toggleFullScreen',
...
// R4 写点：
/** R4 miscRawState 域长尾写点（取代字符串键 writeScopeField('<字段>', v)）。与注册表同一 writer。 */
export function writeCurrentFolderPath(value: any): void { writers.currentFolderPath(value); }
export function writeCurrentId(value: any): void { writers.currentId(value); }
export function writeCurrentTag(value: any): void { writers.currentTag(value); }
export function writeImagesDir(value: any): void { writers.imagesDir(value); }
export function writeLibraryName(value: any): void { writers.libraryName(value); }
export function writeLibraryImagesPath(value: any): void { writers.libraryImagesPath(value); }
export function writeLibraryPath(value: any): void { writers.libraryPath(value); }
export function writeLibraryModificationTime(value: any): void { writers.libraryModificationTime(value); }
export function writeLibraryLoadedProgress(value: any): void { writers.libraryLoadedProgress(value); }
export function writeLibraryHistory(value: any): void { writers.libraryHistory(value); }
export function writeRootDir(value: any): void { writers.rootDir(value); }
export function writeQuickAccess(value: any): void { writers.quickAccess(value); }
export function writeDraggedQuickAccess(value: any): void { writers.draggedQuickAccess(value); }
export function writeSidebarIndex(value: any): void { writers.sidebarIndex(value); }
export function writeSidebarList(value: any): void { writers.sidebarList(value); }
export function writeIsExpandFolder(value: any): void { writers.isExpandFolder(value); }
export function writeIsExpandSmartFolder(value: any): void { writers.isExpandSmartFolder(value); }
export function writeIsExpandQuickAccess(value: any): void { writers.isExpandQuickAccess(value); }
export function writeIsHideMainNav(value: any): void { writers.isHideMainNav(value); }
export function writeSmartFolderList(value: any): void { writers.smartFolderList(value); }
export function writeFolderKeyword(value: any): void { writers.folderKeyword(value); }
export function writeTagKeyword(value: any): void { writers.tagKeyword(value); }
export function writeContainFolders(value: any): void { writers.containFolders(value); }
export function writeContainTags(value: any): void { writers.containTags(value); }
export function writePreelaborations(value: any): void { writers.preelaborations(value); }
export function writeKeywords(value: any): void { writers.keywords(value); }
export function writeKeywords_cn(value: any): void { writers.keywords_cn(value); }
export function writeKeywords_tw(value: any): void { writers.keywords_tw(value); }
export function writeKeyword_cn(value: any): void { writers.keyword_cn(value); }
export function writeKeyword_tw(value: any): void { writers.keyword_tw(value); }
export function writeIsKeywordCN(value: any): void { writers.isKeywordCN(value); }
export function writeIsKeywordTW(value: any): void { writers.isKeywordTW(value); }
export function writeIsEnglish(value: any): void { writers.isEnglish(value); }
export function writeIsContainAlphabet(value: any): void { writers.isContainAlphabet(value); }
export function writeSearchRegexGroup(value: any): void { writers.searchRegexGroup(value); }
export function writeGlobalKeywords(value: any): void { writers.globalKeywords(value); }
export function writeHistorySearchKeywords(value: any): void { writers.historySearchKeywords(value); }
export function writeHsks(value: any): void { writers.hsks(value); }
export function writeKeywordSuggestions(value: any): void { writers.keywordSuggestions(value); }
export function writeKeywordDebounce(value: any): void { writers.keywordDebounce(value); }
export function writeShowSuggestions(value: any): void { writers.showSuggestions(value); }
export function writePage(value: any): void { writers.page(value); }
export function writeColorDistancesMap(value: any): void { writers.colorDistancesMap(value); }
export function writeSearchIndex(value: any): void { writers.searchIndex(value); }

// R4 写点：
/** R4 miscRawState 域长尾写点（取代字符串键 writeScopeField('<字段>', v)）。与注册表同一 writer。 */
export function writeRegistration(value: any): void { writers.Registration(value); }
export function writeAddImageStartTime(value: any): void { writers.addImageStartTime(value); }
export function writeAddImageTimeLeftInSeconds(value: any): void { writers.addImageTimeLeftInSeconds(value); }
export function writeAvailableHistoryTags(value: any): void { writers.availableHistoryTags(value); }
export function writeCanUseTouchID(value: any): void { writers.canUseTouchID(value); }
export function writeCurrentProcessCount(value: any): void { writers.currentProcessCount(value); }
export function writeCurrentTrashRemoved(value: any): void { writers.currentTrashRemoved(value); }
export function writeDownloadQueueLength(value: any): void { writers.downloadQueueLength(value); }
export function writeDuplicateGroupings(value: any): void { writers.duplicateGroupings(value); }
export function writeDuplicateQueue(value: any): void { writers.duplicateQueue(value); }
export function writeDuplicateTarget(value: any): void { writers.duplicateTarget(value); }
export function writeDuplicates(value: any): void { writers.duplicates(value); }
export function writeErrorList(value: any): void { writers.errorList(value); }
export function writeFiltereds(value: any): void { writers.filtereds(value); }
export function writeFinishGenerateQueue(value: any): void { writers.finishGenerateQueue(value); }
export function writeFinishQueue(value: any): void { writers.finishQueue(value); }
export function writeInitDetailMode(value: any): void { writers.initDetailMode(value); }
export function writeIsItemBindCalculated(value: any): void { writers.isItemBindCalculated(value); }
export function writeIsLibrarySaving(value: any): void { writers.isLibrarySaving(value); }
export function writeIsOpenWebpagePanel(value: any): void { writers.isOpenWebpagePanel(value); }
export function writeIsSearchScopeAnnotation(value: any): void { writers.isSearchScopeAnnotation(value); }
export function writeIsSearchScopeExt(value: any): void { writers.isSearchScopeExt(value); }
export function writeIsSearchScopeFolderDesc(value: any): void { writers.isSearchScopeFolderDesc(value); }
export function writeIsSearchScopeFolderName(value: any): void { writers.isSearchScopeFolderName(value); }
export function writeIsSearchScopeName(value: any): void { writers.isSearchScopeName(value); }
export function writeIsSearchScopeNote(value: any): void { writers.isSearchScopeNote(value); }
export function writeIsSearchScopeTag(value: any): void { writers.isSearchScopeTag(value); }
export function writeIsSearchScopeUrl(value: any): void { writers.isSearchScopeUrl(value); }
export function writeIsUILoaded(value: any): void { writers.isUILoaded(value); }
export function writeLastProcessCount(value: any): void { writers.lastProcessCount(value); }
export function writeLastSelectedTag(value: any): void { writers.lastSelectedTag(value); }
export function writeLastestAddItem(value: any): void { writers.lastestAddItem(value); }
export function writeLen(value: any): void { writers.len(value); }
export function writeListLayoutSettings(value: any): void { writers.listLayoutSettings(value); }
export function writeListMetaType(value: any): void { writers.listMetaType(value); }
export function writeLoadMoreDisable(value: any): void { writers.loadMoreDisable(value); }
export function writeMetadataQueueLength(value: any): void { writers.metadataQueueLength(value); }
export function writeNewGroupName(value: any): void { writers.newGroupName(value); }
export function writeOpenWithInfo(value: any): void { writers.openWithInfo(value); }
export function writeOrderBy(value: any): void { writers.orderBy(value); }
export function writeOrderByName(value: any): void { writers.orderByName(value); }
export function writePaletteQueueDelay(value: any): void { writers.paletteQueueDelay(value); }
export function writePaletteQueueLength(value: any): void { writers.paletteQueueLength(value); }
export function writePaletteQueuePaused(value: any): void { writers.paletteQueuePaused(value); }
export function writeProgress(value: any): void { writers.progress(value); }
export function writeRegenerateThumbnailQueue(value: any): void { writers.regenerateThumbnailQueue(value); }
export function writeSaveFolderDebounceTimeout(value: any): void { writers.saveFolderDebounceTimeout(value); }
export function writeSelectingTags(value: any): void { writers.selectingTags(value); }
export function writeShowAnnotation(value: any): void { writers.showAnnotation(value); }
export function writeShowFileExtension(value: any): void { writers.showFileExtension(value); }
export function writeShowFileExtensionLabel(value: any): void { writers.showFileExtensionLabel(value); }
export function writeShowMetas(value: any): void { writers.showMetas(value); }
export function writeShowNTFSWarning(value: any): void { writers.showNTFSWarning(value); }
export function writeShowName(value: any): void { writers.showName(value); }
export function writeShowOriginalImageWhenLarge(value: any): void { writers.showOriginalImageWhenLarge(value); }
export function writeShowSlowNotify(value: any): void { writers.showSlowNotify(value); }
export function writeSortIncrease(value: any): void { writers.sortIncrease(value); }
export function writeTagsSuggestion(value: any): void { writers.tagsSuggestion(value); }
export function writeTrashRemoved(value: any): void { writers.trashRemoved(value); }
export function writeUnlockPassword(value: any): void { writers.unlockPassword(value); }
export function writeUntagged(value: any): void { writers.untagged(value); }
export function writeUploadQueue(value: any): void { writers.uploadQueue(value); }
export function writeUsingCache(value: any): void { writers.usingCache(value); }
export function writeWinMenu(value: any): void { writers.winMenu(value); }
