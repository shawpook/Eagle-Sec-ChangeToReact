...
import { machineryLeaveDetailMode, machineryOpenPluginPanel, machinerySelectNext, machinerySelectPrev, machineryToggleAll, machineryToggleCommentMode, machineryToggleZoom, machineryZoomActual } from '../../core/dataMachinery';
