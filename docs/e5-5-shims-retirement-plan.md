...
> **R6 后的现况（2026-09-14）**：本文是当时的时间语境记录；当前状态、运行命令与验收入口见
> `README.md` 与 `docs/frontend-batch-plan-R0-R7-2026-09-14.md`（R0–R7 批次计划与各批实施结果），
> 交付页面台账见 `docs/frontend-entry-ledger-2026-09-14.md`。

> 立项文档（2026-09-13）。收官状态见 `docs/rewrite-closing-2026-09-13.md` §6.1（该收官文档已不在工作树中）。
