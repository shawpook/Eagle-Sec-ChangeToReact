...
const PENDING_DATA_FIELDS = [
  ...
  'images', 'imagesDir', 'initDetailMode', 'isAppLocked',
  'isCleaningTrash', 'isCommentMode', 'isContainAlphabet', 'isCropMode',
  'isEnglish', 'isExpandFolder', 'isExpandQuickAccess', 'isExpandSmartFolder',
  'isGrayscaleMode', 'isHideMainNav', 'isHideNavigator', 'isHideSidebar',
  'isHideSubFolder', 'isInlineMode', 'isItemBindCalculated', 'isKeywordCN',
  'isKeywordTW', 'isLibrarySaving', 'isMaximize', 'isOpenWebpagePanel',
  ...
  'isSearchScopeTag', 'isSearchScopeUrl', 'isSlideshowMode', 'isUILoaded',
  ...
  'lastSelectedTag', 'lastZoomMode', 'lastestAddItem', 'layoutOptions',
  ...
  'paletteQueuePaused', 'platform', 'preelaborations', 'progress',
  'quickAccess', 'ratio', 'regenerateThumbnailQueue', 'removeProgress',
  ...
  'sliderZoomRatio', 'smartFolderList', 'smartFolderMappings', 'smartFolders',
  'smoothZoomDone', 'sortIncrease', 'tagKeyword', 'tags',
  'tagsSuggestion', 'theme', 'trashRemoved', 'trialRemain',
