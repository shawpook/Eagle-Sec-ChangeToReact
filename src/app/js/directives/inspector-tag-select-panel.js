        ...
        link: (scope, element) => {
            ...
            scope.updateSelected = () => {
                ...
                $timeout(() => {
                    ...
                    // scope.panel.rawData.selectedTags = originSelected;
                    scope.panel.listData.selectedTags = originSelected;
                ...
                $(window).on("resize.inspectTagSelect", () => {
                    ...
                    resizeTimeout = setTimeout(() => {
                        if (scope.panel.isPined) {
                            ...
                            if (!$("inspector-tag-select-panel select-panel").hasClass("open")) return;
            ...
            const initWatcher = () => {
                // 監聽 selected 標籤的變化，當標籤改變時更新建議標籤
